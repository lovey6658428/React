...
import CommenComments from './common_comments'
export default class MobileNewsDetalls extends React.Component{
  constructor(){
    super();
    this.state = {
      newsItem : ''
      ...
      <div class="ucmobileList">
        <Row>
          <Col span={24} className="container">
            ...
            <CommenComments uniquekey={this.props.params.uniquekey} />
          </Col>
        </Row>
        </div>
        <MobileFooter/>
